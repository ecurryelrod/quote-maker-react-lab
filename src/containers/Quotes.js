        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              ...
              {this.props.quotes.map(quote => <QuoteCard key={quote.id} quote={quote} delete={this.props.removeQuote} upvote={this.props.upvoteQuote} downvote={this.props.downvoteQuote} />)}
            </div>
          </div>
        </div>
      </div>
